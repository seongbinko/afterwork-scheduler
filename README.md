...
| 2021.05.18 | Hobbyful 사이트의 isOnline 여부를 true 로 변경 - [최재성] <br/> 탈잉 Refactoring 추가 - [최재성] |
| 2021.05.20 | Class101 코드 수정 - [김남석] |
| 2021.05.21 | 크롤링 종료 후 status가 N인 값 삭제 처리 - [김남석] <br/> 코드리팩토링 - [고성빈] |
| 2021.05.22 | 멀티스레드 방식으로 스케쥴러 변경 - [고성빈] |
| 2021.05.23 | 멀티스레드 종료 방식 변경 - [고성빈] <br/> 남석님, 성빈님의 멀티 스레드 방식을 응용해서 메소드 구현, 기존 탈잉 크롤링 시간: 43분 -> 11분으로 단축 - [최재성] |